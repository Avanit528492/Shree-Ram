...
function vw_travel_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_travel_preloader_bg_color', array(
		'default'           => '#ffffff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_travel_preloader_bg_color', array(
		'label'    => __('Pre-Loader Background Color', 'vw-travel'),
		'section'  => 'vw_travel_left_right',
	)));

	$wp_customize->add_setting('vw_travel_preloader_border_color', array(
		'default'           => '#0ca6ee',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_travel_preloader_border_color', array(
		'label'    => __('Pre-Loader Border Color', 'vw-travel'),
		'section'  => 'vw_travel_left_right',
	)));
    ...
    $wp_customize->add_setting( 'vw_travel_toggle_time',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_travel_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Travel_Toggle_Switch_Custom_Control( $wp_customize, 'vw_travel_toggle_time',array(
		'label' => esc_html__( 'Time','vw-travel' ),
		'section' => 'vw_travel_post_settings'
    )));
