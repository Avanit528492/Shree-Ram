<?php
	...
	if($vw_travel_first_color != false){
		$vw_travel_custom_css .='.lower-header i, .logo h1 a, h6.phone-no, #footer h3, .logo h1 a, .logo p.site-title a, .lower-header p a:hover{';
	...
	if($vw_travel_second_color != false){
		$vw_travel_custom_css .='.post-navigation a:hover .post-title, .post-navigation a:focus .post-title, a, .post-main-box:hover h2, #sidebar ul li a:hover, #footer li a:hover, .main-navigation ul.sub-menu a:hover, .entry-content a, .sidebar .textwidget p a, .textwidget p a, #comments p a, .slider .inner_carousel p a, .post-main-box:hover h2 a, .post-main-box:hover .post-info a, .single-post .post-info:hover a, h6.phone-no a:hover, .logo .site-title a:hover{';
	...
	$vw_travel_preloader_bg_color = get_theme_mod('vw_travel_preloader_bg_color');
	if($vw_travel_preloader_bg_color != false){
		$vw_travel_custom_css .='#preloader{';
			$vw_travel_custom_css .='background-color: '.esc_attr($vw_travel_preloader_bg_color).';';
		$vw_travel_custom_css .='}';
	}

	$vw_travel_preloader_border_color = get_theme_mod('vw_travel_preloader_border_color');
	if($vw_travel_preloader_border_color != false){
		$vw_travel_custom_css .='.loader-line{';
			$vw_travel_custom_css .='border-color: '.esc_attr($vw_travel_preloader_border_color).'!important;';
		$vw_travel_custom_css .='}';
	}