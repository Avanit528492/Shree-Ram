...
function vw_tour_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_tour_lite_preloader_bg_color', array(
		'default'           => '#ffffff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_tour_lite_preloader_bg_color', array(
		'label'    => __('Pre-Loader Background Color', 'vw-tour-lite'),
		'section'  => 'vw_tour_lite_left_right',
	)));

	$wp_customize->add_setting('vw_tour_lite_preloader_border_color', array(
		'default'           => '#0f77e9',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_tour_lite_preloader_border_color', array(
		'label'    => __('Pre-Loader Border Color', 'vw-tour-lite'),
		'section'  => 'vw_tour_lite_left_right',
	)));
    ...
    $wp_customize->add_control( new VW_Tour_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_tour_lite_toggle_comments',array(
   	...
   	$wp_customize->add_setting( 'vw_tour_lite_toggle_time',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_tour_lite_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Tour_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_tour_lite_toggle_time',array(
		'label' => esc_html__( 'Time','vw-tour-lite' ),
		'section' => 'vw_tour_lite_post_settings'
    )));
