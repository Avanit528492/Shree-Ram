			...
			<?php }else{ ?>
			    ...
			    <div class="link-customizer-with-guternberg-ibtana">
					...
					<div class="first-row">
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-buddicons-buddypress-logo"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[control]=custom_logo') ); ?>" target="_blank"><?php esc_html_e('Upload your logo','vw-tour-lite'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-networking"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_tour_lite_social_icon_settings') ); ?>" target="_blank"><?php esc_html_e('Social Icons','vw-tour-lite'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-menu"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[panel]=nav_menus') ); ?>" target="_blank"><?php esc_html_e('Menus','vw-tour-lite'); ?></a>
							</div>
							
							<div class="row-box2">
								<span class="dashicons dashicons-text-page"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_tour_lite_footer') ); ?>" target="_blank"><?php esc_html_e('Footer Text','vw-tour-lite'); ?></a>
							</div>
						</div>

						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-format-gallery"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_tour_lite_post_settings') ); ?>" target="_blank"><?php esc_html_e('Post settings','vw-tour-lite'); ?></a>
							</div>
							 <div class="row-box2">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-admin-generic"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_tour_lite_left_right') ); ?>" target="_blank"><?php esc_html_e('General Settings','vw-tour-lite'); ?></a>
							</div>
							 <div class="row-box2">
					...
					<div class="info-link">
			  		...
			  		<div class="link-customizer">
						...
						<div class="first-row">
							...
							<div class="row-box">
								<div class="row-box1">
									<span class="dashicons dashicons-slides"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_tour_lite_slidersettings') ); ?>" target="_blank"><?php esc_html_e('Slider Settings','vw-tour-lite'); ?></a>
								</div>
								<div class="row-box2">
									<span class="dashicons dashicons-editor-table"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_tour_lite_our_services') ); ?>" target="_blank"><?php esc_html_e('Why Choose Us Section','vw-tour-lite'); ?></a>
								</div>
							</div>
							<div class="row-box">
								<div class="row-box1">
