...
function pleasant_lite_customize_register( $wp_customize ) {
	...
	function pleasant_lite_sanitize_dropdown_pages( $page_id, $setting ) {
	...
	function pleasant_lite_sanitize_checkbox( $checked ) {
		// Boolean check.
	...
	$wp_customize->add_section( 'slider_section', array(
		...
		'priority' => null,
		'description' => __('Featured Image Size Should be ( 1400 x 590 ). More slider settings available in PRO Version','pleasant-lite'),		
     ));	
	
	$wp_customize->add_setting('page-setting7',array(
		'default' => '0',			
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'pleasant_lite_sanitize_dropdown_pages'
	));
	...
	$wp_customize->add_setting('disabled_slides',array(
		'default' => false,
		'sanitize_callback' => 'pleasant_lite_sanitize_checkbox',
		'capability' => 'edit_theme_options',
	));	 
	...
	$wp_customize->add_control( 'disabled_slides', array(
	    ...
	    'section' => 'slider_section',
	    'label' => __('Check To Show This Section','pleasant-lite'),
	    'type' => 'checkbox'
